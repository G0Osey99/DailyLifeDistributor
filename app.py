...
# YouTube navbar-auth cache moved to core/yt_auth_cache.py (ARCH-002) so the
# settings blueprint imports it from a leaf module instead of `from app import`
# (a backwards circular dependency). Re-exported here for existing callers.
from core.yt_auth_cache import (  # noqa: F401 — re-export for app-level callers
